  ...
  <div class="fade-in">
    ...
    <div class="events-container">
      ...
      <div v-else class="events-grid">
        ...
        >
          <!-- Header couleur -->
          <div class="event-card-header" :style="{ background: categorieColors[event.categorie]?.bg }">
            ...
            <div class="event-card-badges">
              ...
              <span v-if="event.statut === 'annule'" class="event-cancelled-badge">Annulé</span>
            </div>
    ...
    <div v-if="pagination.lastPage > 1" class="pagination">
      <button class="page-btn" :disabled="pagination.currentPage === 1"
        @click="changePage(pagination.currentPage - 1)">← Précédent</button>
      <div class="page-info">
      ...
      <button class="page-btn" :disabled="pagination.currentPage === pagination.lastPage"
        @click="changePage(pagination.currentPage + 1)">Suivant →</button>
    </div>
...
.action-btn.cancel { background: #FEF3C7; color: #D97706; }
.action-btn.delete { background: #FEF2F2; color: #DC2626; }
.action-btn:hover  { filter: brightness(.9); transform: scale(1.05); }

/* Loading skeleton */
.skeleton-card { background: #fff; border: 1px solid #E2E8F0; border-radius: 12px; overflow: hidden; }
.skeleton-header {
  height: 72px;
...
.btn-warning:disabled { opacity: .7; cursor: wait; }
.btn-danger {
  display: flex;
  align-items: center;
  justify-content: center;
